#!/usr/bin/env tsx
/**
 * migrate-2026-blog.ts
 *
 * Migrates blog posts from Website/src/blog/2026/** to Website-v2/src/content/blog/2026/**
 ...
 *
 * Usage:
 *   npx tsx scripts/migrate-2026-blog.ts [--dry-run]
 */
...
const CLOUDINARY_FOLDER = "bygregmarine/blog/2026";
const REPO_ROOT = path.resolve(import.meta.dirname, "../..");
const SOURCE_ROOT = path.join(REPO_ROOT, "Website/src/blog/2026");
const DEST_ROOT = path.join(REPO_ROOT, "Website-v2/src/content/blog/2026");
...
async function processPost(srcPath: string): Promise<void> {
  ...
  const dateStr = `2026-${mm}-${dd}T00:00:00Z`;
